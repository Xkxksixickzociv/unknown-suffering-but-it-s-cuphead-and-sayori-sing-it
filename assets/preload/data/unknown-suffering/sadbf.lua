...
leftMissoffsets = {'-4', '2'}  -- you probably won't need these if it's for the opponent
downMissoffsets = {'-5', '1'}  --
upMissoffsets = {'-5', '36'}    --
rightMissoffsets = {'-4', '35'} --
...
name_of_character_xml = 'SadBF_Assets'
name_of_character = 'sadbf'
name_of_notetype = 'A'
